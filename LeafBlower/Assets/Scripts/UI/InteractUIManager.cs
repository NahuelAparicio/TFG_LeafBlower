...
public class InteractUIManager : MonoBehaviour
{
    ...
    private RawImage speechBubble;
    private RawImage exclamation;
    private RawImage tick;
    private RawImage interactIcon;
    private RawImage threePoints;
    ...
    private void Awake()
    {
        ...
        SetIconVisibility(false, tick, exclamation, interactIcon);
    }
